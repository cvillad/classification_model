...
if __name__ == "__main__":
  ...
  parser.add_argument("--bucket-name", "-bn", default="sagemaker-us-west-2-430127992102",
      help="bucket name where we are going to save the data", type=str)
  parser.add_argument("--key-name", "-kn", default="ClassificationModel/data", help="Key name where you want to save"
